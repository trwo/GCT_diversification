...
#Adapted code from Tim Coorens (https://github.com/TimCoorens/Polymerase/tree/master/Signatures)
#Takes the HDP signatures generated as per Robinson et al. 2020. (see hdp_workflow.R in the above hyperlink)
